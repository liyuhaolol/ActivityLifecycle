...
centralPortal {
    ...
    pom {
        //packaging = "aar"
        name = "ActivityLifecycle"
        description = "ActivityLifecycle of Android"
        url = "https://github.com/liyuhaolol/ActivityLifecycle"
        licenses {
            license {
                name = "The MIT License"
                url = "https://github.com/liyuhaolol/ActivityLifecycle/blob/master/LICENSE"
            }
        }
        developers {
            developer {
        ...
        scm {
            connection = "scm:git@github.com/liyuhaolol/ActivityLifecycle.git"
            developerConnection = "scm:git@github.com/liyuhaolol/ActivityLifecycle.git"
            url = "https://github.com/liyuhaolol/ActivityLifecycle"
        }
